...
<html>
	<head>
		...
		<link type="text/css" rel="stylesheet" href="../../../layout/components/css/Navigation.css">
		<link type="text/css" rel="stylesheet" href="../css/detail.css">
		<link type="text/css" rel="stylesheet" href="../../../layout/components/css/Navigation.css">
	</head>
	<body>
	<div class="navigation">
		...
		<nav class="head">
			<div class="logo">
				<img src="/HrtLoge/blackLogo.jpg" alt="logo">
			</div>
			<ul class="menu">
				<li><a href="#" >主页</a></li>
				<li><a href="../TeamDynamics.vue">车队动态</a></li>
				<li><a href="../../AboutUs/AboutUs.vue">关于我们</a></li>
				<li><a href="../../Sponsor/Sponsor.vue">赞助商</a></li>
			</ul>
		</nav>
	</div>
	...
	<!--		<li><a href="../news/index.html">车队动态</a></li>-->
	<!--		<li><a href="../team/index.html">关于我们</a></li>-->
	<!--		<li><a href="sponsor/demo/index.html">赞助商</a></li>-->
	<!--	</ul>-->
	...
	<!--</nav>-->
		...
		<div class="content detail">
			...
			<div class="left">
				...
				<!--ads1 : begin-->
				<div class="ads">
					<div style="width: 100%;line-height: 90px;background-color: #eee;text-align: center;font-size: 20px;">内容</div>
				</div>
				<!--ads1 : end-->
				<!--article : begin-->
				<div class="article">
					<h2>内容</h2>
					<p>内容</p>
					<img src="/Instructions/keira.jpg"/>
					<!--pageGo : begin-->
					<div class="pageGo">
						<a href="detail.vue"></a>
						<span>作者：xxx 日期：xxxx/xx/xx</span>
						<a href="detail.vue"></a>
					</div>
					<!--pageGo : end-->
				</div>
				...
				<!--ads2 : begin-->
				<div class="ads">
					<div style="width: 100%;line-height: 90px;background-color: #eee;text-align: center;font-size: 20px;">内容推荐</div>
				</div>
				<!--ads2 : end-->
				<!--popular1 : begin-->
				<div class="popular">
					...
					<ul class="nt-list p-list">
						<li>
							<a href="detail.vue">
								<span><img src="/Instructions/keira.jpg"/></span>
								<h3>新闻简介</h3>
							</a>
						</li>
						<li>
